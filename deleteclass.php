...
$sql = mysqli_query($link, "SELECT `classid`, `classname`, `teacherid`, `Classcapacity` FROM `Class`");
...
<form method="post">
  <table>
    <tr>
      ...
      <th width="250px">class capacity</th>
    ...
    <tr>
      <td colspan="5"><input type="submit" name="delete" value="Delete Selected Class"></td>
    </tr>
  </table>
</form>
...
if (isset($_POST['delete'])) {
    ...
    $delete_query = "DELETE FROM Class WHERE ClassId IN ($class_ids_str)";
