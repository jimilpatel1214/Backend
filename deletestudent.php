...
$sql = mysqli_query($link, "SELECT studentid, studentname, studentaddress, parentid, classId FROM student");
?>
...
<form method="post">
  <table>
    <tr>
      ...
      <th width="250px"> student address</th>
    ...
    <tr>
      <td colspan="8"><input type="submit" name="delete" value="Delete Selected student"></td>
    </tr>
  </table>
</form>
<?php
    ...
    if (isset($_POST['delete'])) {
        ...
        if (!empty($student_ids)) {
            ...
            $delete_query = "DELETE FROM student WHERE studentid IN ($student_ids_str)";

            if (mysqli_query($link, $delete_query)) {
                echo "Student records deleted successfully.";
            } else {
                echo "Error deleting student records: " . mysqli_error($link);
            }
        } else {
