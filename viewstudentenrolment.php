...
<div class="navbar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="addstudentenrolment.htmil">Student Enrolment</a>
...
<h3>See all student enrolment data </h3>

<table>

    <tr>
        <th width="150px">enrolment id<br><hr></th>
        <th width="250px">parents id<br><hr></th>
        <th width="250px">student id<br><hr></th>
        <th width="250px">student info<br><hr></th>
